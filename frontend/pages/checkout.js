...
//     const rawResponse = await fetch(url, {
//       method: 'POST',
//       body: JSON.stringify({ orderid: orderId, amount: subtotal, cart: cart })
//     });
//     const content = await rawResponse.json();
...
//   return (
//     <div>
//       {/* Have to change the host while production */}
//       <Script type="application/javascript" crossorigin="anonymous" src={`https://securegw-stage.paytm.in/merchantpgpui/checkoutjs/merchants/${process.env.NEXT_PUBLIC_MID}.js" onload="onScriptLoad();`}> </Script>
//       <Script>
//       </Script>
...
//                 onChange={handleChange} id="address" name="address" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
//             </div>
//           </div>
//         </div>
//       </div>
//       <div className="flex items-center flex-col">
//         <button onClick={submit} className="shake-vertical text-white mt-10 bg-indigo-500 mx-12 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg w-1/3">
//           Pay Now
//         </button>
//       </div>
//     </div>
